...
-- 2023-05-29,IZubova,Completed the code
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_IZubova')
	 Begin 
	  Alter Database [Assignment07DB_IZubova] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_IZubova;
	 End
	Create Database Assignment07DB_IZubova;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_IZubova;
...
-- <Put Your Code Here> --
/*SELECT Query without Function
SELECT ProductName, UnitPrice
FROM vProducts
ORDER BY ProductName
*/

-- Adding FORMAT Fuction
...
SELECT TOP 100000
  ...
  ,SUM(Count) AS InventoryCountCategory
...
ORDER BY CategoryName, MONTH(InventoryDate), InventoryCountCategory;
go
-- Check that it works: 
